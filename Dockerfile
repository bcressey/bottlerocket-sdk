...
ENV GOOS="linux"
ENV CGO_ENABLED=1
ENV CFLAGS="-O2 -g1 -gz=zstd -pipe -Wformat -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-clash-protection -fno-omit-frame-pointer"
ENV CXXFLAGS="${CFLAGS}"
